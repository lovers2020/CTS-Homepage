...
export const pageContentByPath: Record<string, PageContent> = {
  ...
  "/company_intro/ac/": {
    ...
    stats: [{ value: "9", label: "원본 인증서" }, { value: "2M", label: "수출의 탑 수상" }],
    sections: [
      {
        ...
        items: [
          ...
          { title: "소재·부품·장비 전문기업", description: "핵심 제조 기술 전문성 확인", image: "/assets/quality/certification-materials-parts.png" },
          { title: "기업부설연구소", description: "연구개발 조직 인정", image: "/assets/quality/certification-research-institute.png" },
          { title: "벤처기업", description: "혁신 성장 기업 확인", image: "/assets/quality/certification-venture.png" },
          { title: "성과공유기업", description: "협력 성과 공유 체계", image: "/assets/quality/certification-performance-sharing.png" },
          { title: "수출프론티어기업", description: "해외 시장 개척 역량", image: "/assets/quality/certification-export-frontier.png" },
          { title: "일자리 우수기업", description: "고용과 근무환경 우수성", image: "/assets/quality/certification-job-excellence.png" },
        ],
      },
      {
        eyebrow: "GLOBAL ACHIEVEMENT",
        title: "수출 및 글로벌 역량",
        items: [
