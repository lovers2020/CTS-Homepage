...
const desktopNavigation = [navigation[1], navigation[2], navigation[0], navigation[3]];
    ...
    >
      <div className="utility-bar">
        <div className="shell utility-bar__inner">
          <p className="utility-tagline">PRECISION COMPONENTS FOR SMART AUTOMATION</p>
          <div className="utility-actions">
            <a href="/exh/">Newsroom</a>
            <a className="support-email" href="mailto:support@cantops.com">
              support@cantops.com
            </a>
            <div className="language-list" aria-label="언어 선택">
      ...
      >
        <div className="mobile-nav__top">
          <a href="/" aria-label="CanTops 홈으로" onClick={() => closeMenu()}>
            <img src="/assets/logo.png" alt="CanTops" />
          </a>
          <button ref={closeButtonRef} type="button" aria-label="메뉴 닫기" onClick={() => closeMenu(true)}>
            <CloseIcon />
          </button>
        </div>
